library(readr)
flair_features <- read_csv("xm/flair_features.csv")
t1_features <- read_csv("xm/t1_features.csv")
t1c_features <- read_csv("xm/t1c_features.csv")
t2_features <- read_csv("xm/t2_features.csv")
label <- read_csv("xm/label.csv")
...
y_test_dy <- test[,4]
test_data_dy <- cbind.data.frame(y_test_dy,X_test_lasso_selected)
